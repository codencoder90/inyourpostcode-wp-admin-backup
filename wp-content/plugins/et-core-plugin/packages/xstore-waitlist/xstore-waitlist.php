...
//            'from_name'          => get_option( 'blogname' ),
        ...
        __("Hi,%s{product_title} is now back in stock on {site_name}.%sYou have been sent this email because your email address was registered in a waiting list for this product.%sIf you would like to purchase {product_title}, please visit the following link:%s{product_link}", 'xstore-core'),
                   '\r\n',
                   '\r\n',
                   '\r\n',
                   '\r\n'
           ...
           __("Hi,%sYou got a waiting list request from {site_name} ({site_url}) for the following:%sCustomer email: {customer_email}%sProduct Name: {product_title}, SKU: {product_sku}%sProduct link: {product_link}", 'xstore-core'),
               '\r\n',
               '\r\n',
               '\r\n',
               '\r\n'
           ...
           __("Hi,%sWe have received your waiting list request from {site_name} for the following:%sProduct Name: {product_title}, SKU: {product_sku}%sProduct link: {product_link}%s%sWe will send you an email once this item is back in stock.", 'xstore-core'),
               '\r\n',
               '\r\n',
               '\r\n',
               '\r\n',
