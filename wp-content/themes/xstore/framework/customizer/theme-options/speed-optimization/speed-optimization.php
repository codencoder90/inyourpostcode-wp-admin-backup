...
add_filter( $hook, function ( $fields ) {
	...
	// Array of fields
	$args = array(
		// 'blog_product_pjax_navigation'	=> array(
		// 	'name'		  => 'blog_product_pjax_navigation',
		// 	'type'        => 'toggle',
		// 	'settings'    => 'blog_product_pjax_navigation',
		// 	'label'       => esc_html__( 'Pjax pagination', 'xstore' ),
		// 	'tooltip' => esc_html__( 'Use Ajax instead of ajax for shop, blog, portfolio paginations.', 'xstore' ),
...
//			'priority'	  => 3,
        ...
        'rocket_delay_js_exclusions'	=> array(
            'name'		  => 'rocket_delay_js_exclusions',
            'type'        => 'toggle',
            'settings'    => 'rocket_delay_js_exclusions',
            'label'       => esc_html__( 'WP Rocket delay JS exclusions', 'xstore' ),
            'tooltip' => esc_html__( 'For maximum performance, enable this option to automatically exclude critical theme-based JavaScript files—such as those for the header, mobile menu, and essential UI components - from WP Rocket’s delay. Disabling it may require manual exclusions to prevent layout shifts and ensure fast, stable loading.', 'xstore' ),
            'section'     => 'general-optimization',
            'default'     => false,
//			'priority'	  => 3,
        ),
...
//			'priority'	  => 8,
        ...
        'global_ajaxify'	=> array(
            'name'		  => 'global_ajaxify',
            'type'        => 'toggle',
            'settings'    => 'global_ajaxify',
            'label'       => esc_html__( 'Enable Ajaxify on website', 'xstore' ),
            'tooltip' => esc_html__( 'Enable the option to allow Ajaxify loading across Elementor widgets on your website to improve dynamic interactions without long page loads. Recommended for smoother user experience.', 'xstore' ),
            'section'     => 'general-optimization',
            'default'     => 0,
//			'priority'	  => 8,
        ),

		'static_block_cache_upd'	=> array(
			'name'		  => 'static_block_cache_upd',
			'type'        => 'toggle',
			'settings'    => 'static_block_cache_upd',
...
//			'priority'	  => 9,
		...
		'flying_pages_upd'	=> array(
			'name'		  => 'flying_pages_upd',
			'type'        => 'toggle',
			'settings'    => 'flying_pages_upd',
...
//			'priority'	  => 12,
		...
		'load_wc_cart_fragments_upd'	=> array(
			'name'		  => 'load_wc_cart_fragments_upd',
			'type'        => 'toggle',
			'settings'    => 'load_wc_cart_fragments_upd',
